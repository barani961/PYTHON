'''C:\\Users\\Sanjay Jerene\\chrome_driver\\chromedriver-win64\\chromedriver.exe'''
...
try:
    ...
    chromedriver_path = "D:\\barani code\\set\\chromedriver.exe"  # Update with your actual path
